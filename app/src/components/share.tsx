...
export default function ShareButton() {
    ...
    const handleSocialShare = (platform: string) => {
        ...
        const text = encodeURIComponent("Check out these products in our catalog");
        ...
        <Popover>
            ...
            <PopoverContent align="end" className="p-0">
                <div className="p-2 shadow-hover bg-secondary">
                    ...
                    <div className="flex gap-3 p-3 rounded-lg group" onClick={handleCopyUrl}>
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10">
                            <Copy className="h-4 w-4 text-primary" />
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-medium text-foreground">Copy URL</span>
                            <span className="text-xs text-muted-foreground">Copy link to clipboard</span>
                        </div>
                    </div>

                    <div className="flex gap-3 p-3 rounded-lg group" onClick={handleNativeShare}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-muted-foreground">Share on more platforms</span>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3 p-3 rounded-lg group" onClick={() => handleSocialShare("twitter")}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-muted-foreground">Share on Twitter/X</span>
                        </div>
                    </div>

                    <div className="flex gap-3 p-3 rounded-lg group" onClick={() => handleSocialShare("facebook")}>
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#1877F2]/10">
                            <Facebook className="h-4 w-4 text-[#1877F2]" />
                        </div>
                        <div className="flex flex-col">
                            <span className="text-sm font-medium text-foreground">Facebook</span>
                            <span className="text-xs text-muted-foreground">Share on Facebook</span>
                        </div>
                    </div>

                    <div className="flex gap-3 p-3 rounded-lg group" onClick={() => handleSocialShare("whatsapp")}>
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-green-950">
                            <svg
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-muted-foreground">Share on WhatsApp</span>
                        </div>
                    </div>
                </div>
            </PopoverContent>
