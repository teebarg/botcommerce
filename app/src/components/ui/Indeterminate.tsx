    ...
    return (
        <React.Fragment>
            <div className="hidden transition-loader h-full w-full z-50 fixed" style={{ height: "auto" }}>
                <div aria-label="Loading..." aria-valuemax={100} aria-valuemin={0} className="flex flex-col gap-2 w-full" role="progressbar">
                    <div className="z-0 relative bg-secondary/50 overflow-hidden h-1 rounded-full">
                        <div
