...
function SheetContent({
    ...
    return (
        <SheetPortal>
            ...
            >
                {children}
                <SheetPrimitive.Close className="glass text-black/70 flex items-center justify-center hover:bg-white/20 transition-color rounded-full h-6 w-6 absolute z-50 top-2 right-4 focus:outline-hidden disabled:pointer-events-none">
