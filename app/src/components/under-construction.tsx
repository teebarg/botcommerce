...
const UnderConstruction: React.FC = () => {
    ...
    return (
        <div className="flex-1 px-4 py-20 md:py-16">
            <div className="mx-auto max-w-4xl text-center">
                <div className={`transform transition-all duration-1000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}>
                    ...
                    <p className="mx-auto mb-12 max-w-2xl text-lg leading-relaxed">
                        This page is currently under active development. Our team is working hard to bring you an exceptional experience. Check back
                        soon!
                    </p>
