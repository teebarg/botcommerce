    ...
    return (
        <div className="bg-card rounded-xl border border-border overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-3 px-4 py-3 border-b border-border">
                ...
                <div>
                    <p className="text-[10px] font-medium uppercase tracking-widest text-muted-foreground mb-1">Status</p>
                    <OrderStatusBadge status={order.status} />
                </div>
                <div>
                    <p className="text-[10px] font-medium uppercase tracking-widest text-muted-foreground mb-1">Items</p>
