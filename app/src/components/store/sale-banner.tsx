...
const SaleBanner: React.FC = () => {
    ...
    return (
        <div className="relative overflow-hidden">
            <div className="relative bg-linear-to-br from-slate-900 via-purple-900 to-slate-900 px-4 py-6">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                        ...
                        <div className="mb-2">
                            <h2 className="font-bold text-white leading-tight text-2xl sm:text-3xl">
                                Save Up To{" "}
                                <span className="bg-linear-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent animate-pulse">
                                    70% Off
                                </span>
                            </h2>
