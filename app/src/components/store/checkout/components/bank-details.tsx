...
const BankDetails: React.FC<Props> = ({ order_number }) => {
    const { account_name, account_number, bank_name } = useConfig();
        ...
        <div className="rounded-xl bg-card p-4 mt-4">
            ...
            <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button
                        type="button"
                        onClick={() => handleCopy("account_number", account_number)}
                        className={cn(
            ...
            <div className="mt-3 pt-3 border-t border-border">
                <p className="text-xs text-muted-foreground leading-relaxed">
                    {order_number && "Paste the order number above into your transfer description."} Your order will be processed once payment is
                    received.
                </p>
            </div>
        </div>
