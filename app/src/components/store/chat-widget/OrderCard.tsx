...
const statusConfig: Record<OrderStatus, { icon: LucideIcon; label: string; color: string; bg: string; progress: number }> = {
    [OrderStatus.PENDING]: { icon: Package, label: "Pending", color: "text-accent-subtle", bg: "bg-accent-subtle/10", progress: 15 },
    ...
    [OrderStatus.OUT_FOR_DELIVERY]: { icon: Truck, label: "Out for Delivery", color: "text-warning", bg: "bg-warning/10", progress: 80 },
    ...
    [OrderStatus.REFUNDED]: { icon: RotateCcw, label: "Refunded", color: "text-destructive", bg: "bg-destructive/10", progress: 100 },
};
