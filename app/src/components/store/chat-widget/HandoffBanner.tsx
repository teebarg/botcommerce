    ...
    >
        <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-secondary border border-border">
                ...
                <span className="text-2xs font-medium text-muted-foreground uppercase tracking-wider">Handoff</span>
            </div>
            <div className="flex-1 h-px bg-border" />
        </div>
        ...
        >
            <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-2xs text-muted-foreground">Human support agent • Just joined</p>
                </div>
            </div>
            <div className="mt-2.5 flex items-center gap-4 pt-2 border-t border-primary/10">
                <div className="flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-500" />
                    <span className="text-2xs text-muted-foreground">Available now</span>
                </div>
                <span className="text-2xs text-muted-foreground">Avg. response: &lt;1 min</span>
            </div>
        </div>
    </div>
);
