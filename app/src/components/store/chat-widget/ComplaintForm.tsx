    ...
    return (
        <form onSubmit={handleSubmit} className="mt-2 rounded-xl border border-border bg-card p-3 space-y-2.5">
            ...
            <div className="space-y-1">
                ...
                {errors.name && <p className="text-2xs text-destructive pl-1">{errors.name}</p>}
            </div>
            ...
            <div className="space-y-1">
                ...
                {errors.email && <p className="text-2xs text-destructive pl-1">{errors.email}</p>}
            </div>
            ...
            <div className="space-y-1">
                ...
                {errors.category && <p className="text-2xs text-destructive pl-1">{errors.category}</p>}
            </div>
            ...
            <div className="space-y-1">
                ...
                {errors.description && <p className="text-2xs text-destructive pl-1">{errors.description}</p>}
            </div>
