...
export default function SearchDialogContent({ isOpen, close, placeholder = "Search for products...", searchDelay = 500 }: SearchDialogContentProps) {
    ...
    const { data: trendingData } = useProductSearch({ collections: "trending", limit: 4 }, isOpen);
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <div className="flex items-center rounded-xl border w-full max-w-lg mx-auto relative">
                    ...
                    <input
                        ref={inputRef}
                        className={cn(
                            "pl-12 pr-12 py-2.5 bg-transparent border-0 outline-0 w-full text-foreground placeholder:text-muted-foreground"
                        )}
