...
const ProductOverview: React.FC<{
    ...
    return (
        ...
        >
                        ...
                        <div>
                            <div className="flex items-center space-x-2">
                                ...
                                {selectedVariant?.old_price > selectedVariant?.price && (
                                    <span className="text-muted-foreground line-through">{currency(selectedVariant?.old_price)}</span>
                                )}
                            </div>
                            {selectedVariant?.old_price > selectedVariant?.price && (
            ...
            <div className="px-4 py-4 border-t border-border space-y-2 gradient-glass">
                <div>
                    <p className="text-xs text-muted-foreground">Total</p>
                    <p className="text-xl font-bold text-foreground">{currency(selectedVariant?.price * quantity || 0)}</p>
                </div>
                <div className="flex gap-2">
                    <Button
