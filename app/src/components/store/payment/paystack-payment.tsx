...
export function PaystackPayment({ amount, canContinue }: PaystackPaymentProps) {
            ...
            <div className="px-4 mt-4">
                <div className="rounded-xl bg-card p-4">
                    ...
                    <ul className="space-y-2">
                        {["Card, bank transfer, or USSD", "Instant confirmation, no delays", "Your card details never touch our servers"].map(
                            (item) => (
