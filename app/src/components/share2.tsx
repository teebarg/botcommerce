...
export default function ShareButton2() {
            ...
            <DropdownMenuContent align="end" className="w-64 p-2 shadow-hover bg-secondary">
                ...
                <DropdownMenuItem className="gap-3 p-3 rounded-lg group" onClick={handleCopyUrl}>
                    ...
                    <div className="flex flex-col">
                        <span className="font-medium text-foreground">Copy URL</span>
                ...
                <DropdownMenuItem className="gap-3 p-3 rounded-lg group" onClick={() => handleSocialShare("whatsapp")}>
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-green-950">
                        <svg className="w-5 h-5 text-white" fill="none" height="25" viewBox="0 0 25 25" width="25" xmlns="http://www.w3.org/2000/svg">
                            <path
