        ...
        <Popover>
            ...
            <PopoverContent align="end" className="p-0">
                <div className="p-2 shadow-hover bg-secondary">
                    ...
                    <div className="flex gap-3 p-3 rounded-lg group cursor-pointer" onClick={copyToClipboard}>
                    ...
                    <div className="flex gap-3 p-3 rounded-lg group cursor-pointer" onClick={() => handleSocialShare("twitter")}>
                    ...
                    <div className="flex gap-3 p-3 rounded-lg group cursor-pointer" onClick={() => handleSocialShare("facebook")}>
                    ...
                    <div className="flex gap-3 p-3 rounded-lg group cursor-pointer" onClick={() => handleSocialShare("whatsapp")}>
