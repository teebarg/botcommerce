...
import { ArrowDownLeft, Check, Copy, Gift, Loader, Share2, ShoppingBag, Wallet } from "lucide-react";
...
//     const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } = useInfiniteQuery<PaginatedWalletTxns>({
//         queryKey: ["wallet", "infinite"],
//         queryFn: async ({ pageParam }) => await clientApi.get<PaginatedWalletTxns>("/wallet/me", { params: { cursor: pageParam } }),
//         initialPageParam: undefined,
//         getNextPageParam: (lastPage: PaginatedWalletTxns) => lastPage.next_cursor ?? undefined,
//         initialData: initialTxns
//             ? {
//                   pages: [initialTxns],
...
//             : undefined,
//     });
//     const txns = data?.pages?.flatMap((p: any) => p.txns) || [];
