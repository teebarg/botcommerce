...
const Trash: React.FC<IconProps> = ({ size = "16", color = "currentColor", ...attributes }) => {
    return (
        <svg fill="none" height={size} viewBox="0 0 20 20" width={size} xmlns="http://www.w3.org/2000/svg" {...attributes}>
            <path d="M3.33301 5.49054H4.81449H16.6663" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path
                ...
                strokeWidth="1.5"
            />
            <path d="M8.33203 9.23724V13.4039" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d="M11.666 9.23724V13.4039" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </svg>
    );
};
