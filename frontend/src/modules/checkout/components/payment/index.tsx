...
const Payment = ({ cart }: { cart: Omit<any, "refundable_amount" | "refunded_total"> | null }) => {
    ...
    const paymentReady = (cart?.payment_session && cart?.shipping_methods.length !== 0) || paidByGiftcard;
