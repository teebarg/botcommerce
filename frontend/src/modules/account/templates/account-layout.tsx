...
const AccountLayout: React.FC<AccountLayoutProps> = ({ customer, children }) => {
    return (
        <div className="flex-1 sm:py-4 px-4 md:px-0" data-testid="account-page">
            <div className="flex-1 h-full max-w-6xl mx-auto bg-content1 flex flex-col rounded-md px-4">
