            ...
            <div className="bg-default-50 flex items-center justify-center flex-1">
                <div className="max-w-lg mx-auto bg-content2 rounded-lg shadow-lg overflow-hidden">
                    <div className="px-6 py-8">
                        ...
                        <p className="text-xl text-default-600 mb-4">Internal Server Error</p>
                        <p className="text-default-700 mb-6">Oops! Something went wrong on our end. We apologize for the inconvenience.</p>
