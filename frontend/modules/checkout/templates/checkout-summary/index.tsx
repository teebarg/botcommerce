...
const CheckoutSummary = async () => {
    ...
    return (
        <div className="relative md:sticky top-0 flex gap-y-8 w-full rounded-medium bg-content2 px-2 py-4 dark:bg-content1 md:px-6 md:py-8 lg:w-[400px] lg:flex-none mt-6 sm:mt-0">
