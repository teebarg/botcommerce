...
const Refresh: React.FC<IconProps> = ({ size = "16", color = "currentColor", ...attributes }) => {
    return (
        <svg fill="none" height={size} viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg" {...attributes}>
            <path d="M19.8007 3.33301V8.53308H14.6006" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path
                ...
                strokeWidth="1.5"
            />
            <path d="M4.2002 20.6669V15.4668H9.40027" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path
