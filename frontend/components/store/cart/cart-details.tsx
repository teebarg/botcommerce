    ...
    return (
        <ClientOnly>
            <div className="rounded-t-2xl min-h-[70vh] max-h-screen overflow-hidden flex flex-col justify-center">
                ...
                {cart?.items?.length && (
                    <p className="bg-default-100 text-default-700 p-2 rounded flex gap-2 mx-4" data-testid="miniBag-urgentMessage-read">
                ...
                <div className="flex-1 overflow-y-auto p-4">
                    {!cart || cart?.items?.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-64 text-center">
                            <ShoppingCart className="h-24 w-24 text-default-300 mb-4" />
                            <p className="text-default-900 font-semibold text-2xl">Your cart is empty</p>
                            <p className="text-default-500">Add items to your cart to view them here.</p>
