...
const SaleBanner: React.FC<SaleBannerProps> = ({ className = "", variant = "full", showBackground = true }) => {
    ...
    return (
        <div className={cn("relative overflow-hidden", className)}>
            <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 px-4 py-6">
                ...
                <div className="relative z-10 flex items-center justify-between text-white max-w-7xl mx-auto flex-col sm:flex-row gap-4 sm:gap-6">
                    <div className={`flex-1 text-center sm:text-left" ${isInline ? "text-center" : "text-center sm:text-left"}`}>
                        ...
                        <div className="mb-3">
                            <h2 className="font-bold text-white leading-tight text-2xl sm:text-3xl lg:text-4xl">
                                Save Up To{" "}
                  ...
                  border-0 group px-8 py-3 text-lg"
                                size="lg"
                            >
                                Shop Now
