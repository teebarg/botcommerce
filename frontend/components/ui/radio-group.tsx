...
const radioVariants = {
    default: {
        ...
        item: "border-input text-indigo-600 focus-visible:border-ring focus-visible:ring-ring/50 aspect-square size-4 shrink-0 rounded-full border shadow-xs transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",
    ...
    delivery: {
        container: "grid gap-2",
        item: "flex items-start space-x-4 p-6 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:shadow-accent border-border hover:border-accent/50 data-[state=checked]:border-accent data-[state=checked]:bg-accent/10 data-[state=checked]:shadow-accent group relative focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
        indicator: "flex items-center justify-center",
        icon: "size-4 opacity-0 transition-opacity duration-200 group-data-[state=checked]:opacity-100",
    },
};
