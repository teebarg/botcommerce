        ...
        <>
            <React.Fragment>
                <div className="flex flex-col gap-3 h-full" id={`${product.id}`}>
                    ...
                    <div className="relative flex max-h-full w-full flex-col items-center overflow-hidden rounded-xl bg-content2 h-[15rem] md:h-[22rem] justify-between">
                        <div className="relative md:rounded-1xl z-0 w-full md:w-[80%] overflow-visible h-full">
                            {product.image && (
                                <Image
                                    fill
                                    alt={product.name}
