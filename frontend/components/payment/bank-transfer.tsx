        ...
        <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600">Your E-Shop Name Ltd.</p>
                </div>
                <p className="text-xs text-gray-500 mt-2">Please use your order number as reference when making the transfer.</p>
            </div>
