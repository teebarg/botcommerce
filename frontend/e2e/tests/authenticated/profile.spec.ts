...
test.describe("Account profile tests", () => {
    test("Profile completed update flow", async ({ accountOverviewPage: overviewPage, accountProfilePage: profilePage }) => {
    ...
    test("Verifies password changes work correctly", async ({ loginPage, accountProfilePage: profilePage, accountOverviewPage: overviewPage }) => {
