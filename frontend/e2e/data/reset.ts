...
function getEnv() {
    return {
        ...
        testDatabase: process.env.TEST_POSTGRES_DATABASE || "test_db",
        testDatabaseTemplate: process.env.TEST_POSTGRES_DATABASE_TEMPLATE || "test_db_template",
        productionDatabase: process.env.PRODUCTION_POSTGRES_DATABASE || "db",
        superuser: {
