        ...
        <div className="bg-content2">
            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                    <div className="bg-secondary p-8 rounded-xl shadow-sm border border-divider hover:shadow-md transition-shadow cursor-pointer group">
                ...
                <div className="rounded-xl shadow-sm border border-divider p-8">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <details key={index} className="group">
                                <summary className="flex justify-between items-center cursor-pointer p-4 bg-secondary rounded-lg transition-colors">
